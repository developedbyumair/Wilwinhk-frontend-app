...
import { DeleteFav, RemovefromFav } from "../../../../Store/Features/favSlice";

function FavDrawer() {
  const dispatch = useDispatch();
  const compare = useSelector((state) => state.fav.productsFav);
  ...
  const handleDeletesingle = (e) => {
    ...
    dispatch(RemovefromFav({ productsID: e._id }));
  };
  return (
